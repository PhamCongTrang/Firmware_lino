...
#define COUNTS_PER_REV 1232       // wheel encoder's no of ticks per rev
...
//MOTOR PINS
  ...
  #define MOTOR3_IN_A 50
  #define MOTOR3_IN_B 51

  #define MOTOR4_PWM 16
  #define MOTOR4_IN_A 52
  #define MOTOR4_IN_B 53
